...
public class RedisClient {
	    ...
	    { 
	        ...
	        shards.add(new JedisShardInfo("192.168.160.133", 6379, "master")); 
...
//	        SortedSetOperate();
	      ...
	      private void ListOperate() {
	          ...
	          System.out.println("子串-第二个开始到结束："+shardedJedis.lrange("stringlists", 1, 2));
	          System.out.println("子串-第二个开始到结束："+shardedJedis.lrange("stringlists", -2,-1));
	          // 获取列表指定下标的值 
